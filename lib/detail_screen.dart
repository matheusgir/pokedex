        ...
        children: [
          ...
          Positioned(
            top: 70,
              ...
              child: Row(
                ...
                children: [
                  Text(widget.pokemonDetail['name'],style: const TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold), textAlign: TextAlign.left,),
                  Text("#" + widget.pokemonDetail['num'],style: const TextStyle(color: Colors.white, fontSize: 20, ), textAlign: TextAlign.left,),
          ...
          Positioned(
              ...
              Padding(
                ...
                child: Text(widget.pokemonDetail['type'].join(", "),style: const TextStyle(color: Colors.white, fontSize: 15), textAlign: TextAlign.left,),
              ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: width * 0.3,
                            child: const Text('Weight', style: TextStyle(color: Colors.blueGrey, fontSize: 17),),
                          ),
                          Container(
                            child: Text(widget.pokemonDetail['weight'], style: const TextStyle(color: Colors.black, fontSize: 17),),
                          ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: width * 0.3,
                            child: const Text('Spawn Time', style: TextStyle(color: Colors.blueGrey, fontSize: 17),),
                          ),
                          Container(
                            child: Text(widget.pokemonDetail['spawn_time'], style: const TextStyle(color: Colors.black, fontSize: 17),),
                          ),
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index){
                                    return Padding(
                                      ...
                                      child: Text(widget.pokemonDetail['prev_evolution'][index]['name'], style: const TextStyle(color: Colors.black, fontSize: 17),),
                                    );
                                  },
                                ),
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index){
                                      return Padding(
                                        ...
                                        child: Text(widget.pokemonDetail['next_evolution'][index]['name'], style: const TextStyle(color: Colors.black, fontSize: 17),),
                                      );
                                    },
                                  ),
